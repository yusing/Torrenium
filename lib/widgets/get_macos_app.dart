...
import '/utils/get_macos_controller.dart';

class GetMacosApp extends StatelessWidget {
  static GetMacosController rootController = GetMacosController();
  ...
  final MacosScrollBehavior? scrollBehavior;
  final MacosThemeData? highContrastTheme;
  final MacosThemeData? highContrastDarkTheme;
  ...
  @override
  Widget build(BuildContext context) => GetBuilder<GetMacosController>(
        init: rootController,
        dispose: (d) {
          onDispose?.call();
        },
        ...
        builder: (_) => routerDelegate != null
            ? MacosApp.router(
                ...
                color: color,
                theme: _.theme ?? theme ?? MacosThemeData.fallback(),
